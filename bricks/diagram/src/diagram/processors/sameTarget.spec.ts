...
describe("sameTarget", () => {
  ...
  test("should return true if both targets have the same node id", () => {
    const target1: ActiveTarget = { type: "node", nodeId: "target1" };
    const target2: ActiveTarget = { type: "node", nodeId: "target1" };
  ...
  test("should return false if both targets have different node ids", () => {
    const target1: ActiveTarget = { type: "node", nodeId: "target1" };
    const target2: ActiveTarget = { type: "node", nodeId: "target2" };
    const result = sameTarget(target1, target2);
