...
```tsx
import { WrappedEoFormatterNumber } from "@easyops/wrapped-components";
```
...
```tsx
<WrappedEoFormatterNumber value={314159265} />
```
...
```tsx
<WrappedEoFormatterNumber value={314159265} type="currency" />
```
...
```tsx
<WrappedEoFormatterNumber value={0.314159265} type="percent" />
```
...
```tsx
<WrappedEoFormatterNumber fallback="-" />
```
