...
```tsx
import { WrappedEoImgIcon } from "@easyops/wrapped-components";
```
...
<WrappedEoImgIcon
  ...
  imgStyle={{ width: 48, height: 48, borderRadius: "50%" }}
/>
```
...
```tsx
<WrappedEoImgIcon imgSrc="/static/icons/my-icon.png" noPublicRoot={true} />
```
