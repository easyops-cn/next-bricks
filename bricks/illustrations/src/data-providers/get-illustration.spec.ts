...
} from "./get-illustration.js";

jest.mock("../generated/categories.js", () => ({
  default: {
    "no-content": "images/default/no-content.png",
    "no-content-dark": "images/default/no-content-dark.png",
  },
  feedback: {
    exception: "images/feedback/exception.png",
  },
}));
...
describe("Illustration", () => {
  it("should work", () => {
    ...
    expect(result).toBe("images/feedback/exception.png");
  });

  it("should work with default category and theme", () => {
    const result = getIllustration({
      name: "no-content",
    });

    expect(result).toBe("images/default/no-content.png");
  });
