...
${element.map(e => `import "@shoelace-style/shoelace/dist/components/${e}/${e}.js";`).join("\n")}
...
const indexContent = elements.map((element) => `import "./${Array.isArray(element) ? element[0] : element}.js";`).join("\n");
